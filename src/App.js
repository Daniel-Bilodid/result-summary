  ...
  return (
    <main className="bg-primary w-full h-screen  flex items-center justify-center ">
      <div className="bg-secondary shadow-lg rounded-3xl flex max-md:flex-col w-736 h-512">
        ...
        >
          <h1 className="text-2xl text-result flex justify-center pt-8">
            Your Result
          </h1>

          <div className="flex justify-center pt-8">
            <div
              className="bg-gradient-2 rounded-full flex justify-center items-center"
        ...
        <aside style={{ width: "368px", height: "512px" }}>
          ...
          <div
            className="flex justify-between ml-9 mt-4 bg-lightGreen rounded-xl"
            style={{ width: "288px", height: "56px" }}
          >
            <div className="flex">
              <svg
          ...
          <div
            className="flex justify-between ml-9 mt-4 bg-lightBlue rounded-xl"
            style={{ width: "288px", height: "56px" }}
          >
            <div className="flex">
              <svg
